    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl px-5 py-10">
        <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-900 px-6 py-12 md:px-12">
          ...
          <div className="relative mt-10 flex gap-8 text-sm"><div><strong className="block text-2xl text-slate-900">{vehicles.length}</strong><span className="text-slate-300">Vehicles shown</span></div><div><strong className="block text-2xl text-slate-900">100%</strong><span className="text-slate-300">Live inventory</span></div><div><strong className="block text-2xl text-slate-900">24/7</strong><span className="text-slate-300">Online access</span></div></div>
        </section>
